...
public class SideCameraRecorder : MonoBehaviour {
    ...
    void Start () {
        ...
        myCameraEnable = GameObject.Find("Parameters").GetComponent<Parameters_CarCamera>().isSideCameraEnabled();
        myCameraRecordingEnable = GameObject.Find("Parameters").GetComponent<Parameters_CarCamera>().isSideCameraRecordingEnabled();
